...
export const DOC_LINKS = {
    ...
    CREATE_CLUSTER_WITHPREMISE: 'https://access.redhat.com/documentation/en-us/red_hat_advanced_cluster_management_for_kubernetes/2.4/html-single/clusters/index#creating-a-cluster-on-premises',
